                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th style="width:90px;text-align:right">testAPI1</th>
                                    <th style="width:30px;text-align:center">
                                        <i class="operation fa fa-minus bg-yellow" onclick="add()"></i>
                                    </th>
                                </tr>
                                <tr>
                                    <th style="width:10px">2.</th>
                                    <th style="width:90px;text-align:right">testAPI2</th>
                                    <th style="width:30px;text-align:center">
                                        <i class="operation fa fa-minus bg-yellow" onclick="add()"></i>
                                    </th>
                                </tr>
                                <tr>
                                    <th colspan="2" style="width:90px;text-align:right">
                                        <input type="text" style="width:180px">
                                    </th>
                                    <th style="width:30px;text-align:center">
                                        <i class="operation fa fa-plus bg-yellow" onclick="add()"></i>
                                    </th>
                                </tr>
                            </tbody>
                        </table>
